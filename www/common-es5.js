...
var AjustesService = /** @class */ (function () {
    function AjustesService() {
        this.fecha = Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["formatDate"])(new Date(), 'dd/MM/yyyy', 'en');
    }
    AjustesService.prototype.ngOnInit = function () {
    };
    AjustesService.prototype.marcarfase3 = function () {
        console.log("Acabas de marcar Fase 3");
        this.fase = "Fase 3";
    };
    AjustesService.prototype.marcarfase4 = function () {
