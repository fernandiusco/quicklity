...
var TablaPageModule = /** @class */ (function () {
    function TablaPageModule() {
    }
...
var TablaPage = /** @class */ (function () {
    function TablaPage(http, papa, plt, miServicio, file, socialSharing, NavCrtl) {
        this.http = http;
        this.papa = papa;
        this.plt = plt;
    ...
    TablaPage.prototype.loadCSV = function () {
        var _this = this;
    ...
    TablaPage.prototype.ngOnInit = function () {
    ...
    TablaPage.prototype.extractData = function (res) {
        var _this = this;
        var csvData = res || '';
        this.papa.parse(csvData, {
            complete: function (parsedData) {
                _this.headerRow = parsedData.data.splice(1, 0)[0];
                _this.csvData = _this.miServicio.tabla;
            }
        });
    };
    TablaPage.prototype.trackByFn = function (index, item) {
        return index;
    };
    TablaPage.prototype.exportCSV = function () {
        var _this = this;
        ...
        if (this.plt.is('cordova')) {
            this.file.writeFile(this.file.dataDirectory, this.titulo, csv, { replace: true }).then(function (res) {
    ...
    TablaPage.prototype.volver = function () {
        this.NavCrtl.navigateBack('/marcador');
    };
    TablaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=tabla-tabla-module-es5.js.map