...
var MarcadorPageModule = /** @class */ (function () {
    function MarcadorPageModule() {
    }
...
var MarcadorPage = /** @class */ (function () {
    function MarcadorPage(navCrtl, miServicio, toastController, alertController, http, papa, storage) {
    ...
    MarcadorPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    MarcadorPage.prototype.loadCSV = function () {
        var _this = this;
    ...
    MarcadorPage.prototype.extractData = function (res) {
        var _this = this;
        var csvData = res || '';
        this.papa.parse(csvData, {
            complete: function (parsedData) {
                _this.headerRow = parsedData.data.splice(1, 0)[0];
                _this.csvData = parsedData.data;
            }
        });
    };
    MarcadorPage.prototype.nuevalinea = function () {
    ...
    // Escribir en modelo tabla CSV -----------------------------------
    MarcadorPage.prototype.ocultaromegastraseras = function () {
        this.omegastras = false;
    };
    MarcadorPage.prototype.iratabla = function () {
        this.navCrtl.navigateForward('/tabla');
    };
    MarcadorPage.prototype.marcarfr = function (fr) {
    ...
    MarcadorPage.prototype.marcaromega = function (str) {
        this.str1 = str;
        console.log("str1 " + this.str1);
        this.omegacolor = "success";
    };
    MarcadorPage.prototype.marcarlado = function (lad) {
        this.lado = lad;
        if (lad == "LH") {
    ...
    MarcadorPage.prototype.marcarnudo = function (nud) {
        this.nudo = nud;
        this.Nudocolor = "success";
    };
    MarcadorPage.prototype.marcarintpiel = function (ip) {
        this.intpiel = ip;
        if (ip == "INTERIOR") {
    ...
    MarcadorPage.prototype.remache = function () {
        if (this.q == undefined) {
            this.q = 0;
        }
    ...
    MarcadorPage.prototype.pieza = function () {
        if (this.q == undefined) {
            this.q = 0;
        }
    ...
    MarcadorPage.prototype.remachenc = function () {
        if (this.q == undefined) {
            this.q = 0;
        }
    ...
    MarcadorPage.prototype.piezanc = function () {
        if (this.q == undefined) {
            this.q = 0;
        }
    ...
    MarcadorPage.prototype.otros = function () {
        this.nuevalinea();
        this.aviso();
    };
    MarcadorPage.prototype.aviso = function () {
    ...
    MarcadorPage.prototype.popupotros = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    MarcadorPage.prototype.resetearvariables = function () {
        this.q = undefined;
    ...
    MarcadorPage.ctorParameters = function () { return [
...
//# sourceMappingURL=marcador-marcador-module-es5.js.map